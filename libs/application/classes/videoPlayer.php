        ...
        */
        ...
        $this->player =  
          ...
          <div id="' . $vname .'">	 	
			...
			swfobject.embedSWF("/flash/flvplayer.swf?contentpath=&preview=&video='.$this->video.'&captions=&preroll=&autoplay='.$this->autoplay.'&loop=&islive=true&volume=0.5&smoothing=true&autoscale=true&videowidth=' . $this->width . '&videoheight=' . $this->height .'&skincolor=0x000000&skinscalemaximum=&skin=skin-applestyle.swf&preloader=&buttonoverlay=&ending=&debug=", "' . $vname .'", "' . $this->width . '", "' . $this->height . '", "9.0.28", "expressInstall.swf", playervars, { scale: "noscale", allowfullscreen: "true",salign: "tl", bgcolor: "#000000", base: "."},  { align: "left"});
			</script>
			</div>'; 
