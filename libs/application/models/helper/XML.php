...
class helper_XML {
	...
	*/
	...
	// XML to Array
	static function xml2ary(&$string) {
	...
	// Array to XML
	static function ary2xml($cary, $d=0, $forcetag='') {
		$res=array();
	...
	static function ins2ary(&$ary, $element, $pos) {
