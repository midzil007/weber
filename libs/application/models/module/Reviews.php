...
{  
	...
	private $key = 'a329cb901fb108d2cd110377faa8ba33';
	...
	function showSingleRev($nodeId){
			$data = $this->db->fetchall('select * from '.$this->_tableNameProd.' where id_node =? order by date desc',$nodeId);
