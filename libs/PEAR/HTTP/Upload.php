    ...
    function HTTP_Upload_Error($lang = null, $html = false)
    {
        ...
        $this->error_codes = array(
            ...
            'NO_WRITE_PERMS' => array(
            	'cz'    => 'Složka do které nahráváte nema dostatečné oprávnění. Prosím kontaktuje administrátora.',
            ...
            'NO_USER_FILE' => array(
            	'en'    => 'Prosím zvolte soubor který chcete nahrát.',
            ...
            'E_FAIL_COPY' => array(
            	'cz'    => 'Chyba při nahrávání. Prosím kontaktuje administrátora.',
            ...
            'FILE_EXISTS' => array(
            	'cz'    => 'Chyba při nahrávání. Soubor již existuje.',
            ...
            'NOT_ALLOWED_EXTENSION' => array(
            	'cz'    => 'Soubor s touto příponou nelze nahrát.',
            ...
            'PARTIAL' => array(
            	'cz'    => 'Chyba při nahrávání. Prosím opakujte akci.',
...
class HTTP_Upload_File extends HTTP_Upload_Error
{
    ...
    function nameToSafe($name, $maxlen=250)
    {
		...
		$name = Utils::generatePathName($name,'.-_', $this->dirToUpload . '/');
