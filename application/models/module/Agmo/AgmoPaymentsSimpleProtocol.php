...
class module_Agmo_AgmoPaymentsSimpleProtocol {
    ...
    public function __construct( $config) {
		$this->_paymentsUrl = $config->agmo->paymentsUrl;
        $this->_merchant = $config->agmo->merchant;
        $this->_test = $config->agmo->test;
        $this->_secret = $config->agmo->secret;
    }
     ...
     * @throws Exception
     */
    public function createTransaction($country, $price, $currency, $label, $refId, $payerId, $vatPL = '', $category = '', $method = 'ALL',$eetData = false, $account = '', $email = '', $phone = '', $productName = '', $language = '') {
